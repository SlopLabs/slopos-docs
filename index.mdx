...
<CardGroup cols={2}>
  ...
  <Card title="GitHub" icon="github" href="https://github.com/SlopLabs/slopos">
...
SlopOS welcomes contributions. Check the [AGENTS.md](https://github.com/SlopLabs/slopos/blob/main/AGENTS.md) file for coding guidelines, commit conventions, and the lore system requirements.
